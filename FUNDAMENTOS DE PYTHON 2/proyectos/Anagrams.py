...
#usando todas las letras originales exactamente una vez. Por ejemplo, 
#las frases "rail safety" y "fairy tales" son anagramas, mientras que "I am" y "You are" no lo son.
