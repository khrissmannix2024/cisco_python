...
# INFO EXTRA  
# Por cierto, observa la función print(). 
# La forma en que lo hemos utilizado aquí se llama impresión multilínea. 
# Puedes utilizar comillas triples para imprimir cadenas en varias líneas 
# para facilitar la lectura del texto o crear un diseño especial basado en texto. 
# Experimenta con ello.

numero_mago = int(input("Ingresa el número del mago: "))
intento = int(input("""
+================================+
