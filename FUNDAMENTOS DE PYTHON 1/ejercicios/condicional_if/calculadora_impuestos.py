...
ingreso = float(input("Introdusca el ingreso de la persona: "))
if ingreso < 85528:
    impuesto = ((ingreso * 18) / 100) - 556.002

if ingreso > 85528:
    excedente = ingreso - 85528
    impuesto = 14839.002 + ((excedente * 32) / 100)

if impuesto < 0:
    print("El impuesto calculado es: 0")
else: 
    print("El impuesto calculado es: ", float(round(impuesto,0)), " pesos.")